...
ENV JOOMLA_DB_HOST=$MYSQLHOST:$MYSQLPORT
ENV JOOMLA_DB_NAME=$MYSQLDATABASE
ENV JOOMLA_DB_USER=$MYSQLUSER
ENV JOOMLA_DB_PASSWORD=$MYSQLPASSWORD
ENV JOOMLA_TABLE_PREFIX="RJ_"
